...
public class ProfileView implements View
{
    ...
    private void viewSetup()
    {
        ...
        if( this.isEdit )
        {
            ...
            String date = Integer.toString( dob.get(Calendar.DATE) );
            String month = Integer.toString( dob.get(Calendar.MONTH) );
            String year = Integer.toString( dob.get(Calendar.YEAR) );
